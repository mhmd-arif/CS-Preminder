...
namespace Preminder.Repository
{
    ...
    {
        // Variables
        readonly private static string connstring = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Database\PreminderDataSet.mdf;Integrated Security=True";
